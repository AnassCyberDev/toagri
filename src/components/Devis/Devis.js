...
export const Devis = () => {
    ...
    const sendContact=async(data)=>{
        const request=await fetch(`/app/api/devis/`,{
            method:"POST",
            body:data
        })
    ...
    const onSubmit=async(e)=>{
        ...
        formdata.append('buried',buried)
        formdata.append('accessibility',accessibility)
        formdata.append('plug',plug)
                        ...
                        <div className='row w100'>
                            ...
                            <div className='col-md-6'>
                                <div class="input-group  input-group-lg mb-3">
                                    ...
                                    <input type="text" class="form-control trensparent-bg" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" onChange={(e)=>setPostal_code(e.target.value)} value={postal_code} style={{height:57}} placeholder=" Code Postal*"/>
                                </div>
