...
import logoLight from '../Styling/img/bovin/logo-light.png'
import Tractor from '../Styling/img/bovin/7.png'
...
const onSubmit=async(e)=>{
  ...
  return (
    ...
    <div className='container-fluid'>
      <div className='row' style={{minHeight:330}}>
      
        <div className='col-lg-3 col-md-12 order-2 order-md-1 text-center footerLogo'>
          <img src={logoLight} style={{width:'60%', marginTop:40,marginBottom:30}} alt="Footer Logo"/>
        </div>
        ...
        <div className='col-lg-3 col-md-4 order-4 order-md-3 footerAlignement'>
          ...
          <div className='footerItem'>
            <div className='flexRowFooter m-2'>
              ...
              <div className='ms-2'>contact@toagri.com</div>
            </div>
          </div>
          <div className='footerItem'>
            <div className='flexRowFooter m-2'>
              ...
              <div className='ms-2'>+212 (0)6 11 22 33 44</div>
            </div>
          </div>
          <div className='footerItem'>
            <div className='flexRowFooter m-2'>
              ...
              <div className='ms-2'>Vos produits sur mesure</div>
            </div>
          </div>
        </div>
      ...
      <div className='row'>
        <div className='footerCopyright col'>
          toagri 2025 copyright<img src={vectorCopy} style={{marginLeft:10}} alt="Copyright"/>
        </div>
      </div>
    </div>
  </section>
